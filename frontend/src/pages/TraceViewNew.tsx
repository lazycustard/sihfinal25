  ...
  const timelineSteps = [
    {
      ...
      details: {
        ...
        farmer: traceData.farmerName || t('unknownFarmer'),
        productName: traceData.productName || traceData.name || t('unknownProduct')
      }
    },
    {
      id: 'processing',
      ...
      details: {
        ...
        processor: traceData.processorName || t('unknownProcessor'),
        productName: traceData.productName || traceData.name || t('unknownProduct')
      }
    },
    {
      ...
      details: {
        ...
        distributor: traceData.distributorName || t('unknownDistributor'),
        productName: traceData.productName || traceData.name || t('unknownProduct')
      }
    },
    {
      ...
      details: {
        ...
        retailer: traceData.retailerName || t('unknownRetailer'),
        productName: traceData.productName || traceData.name || t('unknownProduct')
      }
    }
  ];
